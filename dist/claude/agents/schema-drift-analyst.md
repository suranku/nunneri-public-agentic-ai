---
name: schema-drift-analyst
description: Detect breaking schema changes
model: claude-sonnet-4-6
tools: Read, Grep, Glob, Bash, Write, Edit
---

> Generated from `assets/agents/analysis/schema-drift-analyst.md`. Edit the canonical asset, not this file.

# schema-drift-analyst
...
- The user asks for help related to detect breaking schema changes.
