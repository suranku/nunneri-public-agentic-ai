---
name: prodops-specialist
description: Incident classification against known patterns
model: claude-sonnet-4-6
tools: Read, Grep, Glob, Bash, Write, Edit
---

> Generated from `assets/agents/operations/prodops-specialist.md`. Edit the canonical asset, not this file.
...
- The user asks for help related to incident classification against known patterns.
