---
name: javascript-bug-analyzer
description: Read-only diagnosis for javascript bugs
model: claude-sonnet-4-6
tools: Read, Grep, Glob, Bash, Write, Edit
---

> Generated from `assets/agents/triage/javascript-bug-analyzer.md`. Edit the canonical asset, not this file.

# javascript-bug-analyzer
...
- The user asks for help related to read-only diagnosis for javascript bugs.
