...
> Generated from `assets/agents/compliance/agent-context-generator.md`. Edit the canonical asset, not this file.
...
- The user asks for help related to generate or augment provider-specific repo context files.
