---
name: go-triage-specialist
description: Full 9-phase bug triage workflow for go
model: claude-sonnet-4-6
tools: Read, Grep, Glob, Bash, Write, Edit
---

> Generated from `assets/agents/triage/go-triage-specialist.md`. Edit the canonical asset, not this file.

# go-triage-specialist
...
- The user asks for help related to full 9-phase bug triage workflow for go.
