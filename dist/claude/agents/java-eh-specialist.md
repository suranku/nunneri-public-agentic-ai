---
name: java-eh-specialist
description: Exception handling compliance audit for java
model: claude-sonnet-4-6
tools: Read, Grep, Glob, Bash, Write, Edit
---

> Generated from `assets/agents/compliance/java-eh-specialist.md`. Edit the canonical asset, not this file.
...
- The user asks for help related to exception handling compliance audit for java.
