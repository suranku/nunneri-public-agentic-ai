---
name: python-eh-specialist
description: Exception handling compliance audit for python
model: claude-sonnet-4-6
tools: Read, Grep, Glob, Bash, Write, Edit
---

> Generated from `assets/agents/compliance/python-eh-specialist.md`. Edit the canonical asset, not this file.

# python-eh-specialist
...
- The user asks for help related to exception handling compliance audit for python.
