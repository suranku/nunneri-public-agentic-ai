---
name: impact-analyst
description: Forward lineage from any changed object
model: claude-sonnet-4-6
tools: Read, Grep, Glob, Bash, Write, Edit
---

> Generated from `assets/agents/analysis/impact-analyst.md`. Edit the canonical asset, not this file.
...
- The user asks for help related to forward lineage from any changed object.
