---
name: javascript-eh-specialist
description: Exception handling compliance audit for javascript
model: claude-sonnet-4-6
tools: Read, Grep, Glob, Bash, Write, Edit
---

> Generated from `assets/agents/compliance/javascript-eh-specialist.md`. Edit the canonical asset, not this file.

# javascript-eh-specialist
...
- The user asks for help related to exception handling compliance audit for javascript.
