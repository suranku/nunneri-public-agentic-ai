---
name: report-gap-analyst
description: BRD-to-code gap analysis
model: claude-sonnet-4-6
tools: Read, Grep, Glob, Bash, Write, Edit
---

> Generated from `assets/agents/reporting/report-gap-analyst.md`. Edit the canonical asset, not this file.
...
- The user asks for help related to brd-to-code gap analysis.
