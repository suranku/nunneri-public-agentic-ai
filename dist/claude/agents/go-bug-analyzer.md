---
name: go-bug-analyzer
description: Read-only diagnosis for go bugs
model: claude-sonnet-4-6
tools: Read, Grep, Glob, Bash, Write, Edit
---

> Generated from `assets/agents/triage/go-bug-analyzer.md`. Edit the canonical asset, not this file.
...
- The user asks for help related to read-only diagnosis for go bugs.
